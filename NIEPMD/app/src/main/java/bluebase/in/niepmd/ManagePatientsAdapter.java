...
class ManagePatientsAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ManagePatientsItems> items;

    public ManagePatientsAdapter(Context context, ArrayList<ManagePatientsItems> items){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.manage_patients_list, parent, false);
        }
        ...
        ManagePatientsItems currentItem = (ManagePatientsItems) getItem(position);
