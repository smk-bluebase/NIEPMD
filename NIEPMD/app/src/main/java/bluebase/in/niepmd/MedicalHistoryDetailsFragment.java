...
public class MedicalHistoryDetailsFragment extends Fragment {
    ...
    String urlMedicalHistoryDetails = CommonUtils.IP + "/NIEPMD/NIEPMDandroid/patient/medical_history_details.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_medical_history_details, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        jsonObject.addProperty("viewId", ((PatientActivity) getActivity()).getViewId());
